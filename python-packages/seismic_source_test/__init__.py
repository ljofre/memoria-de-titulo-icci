...
import os
import unittest
from seismic_source import importEvent, SeismicEvent
...
class test_seismic(unittest.TestCase):
    ...
    def testSignal(self):
        """testear que la se~nal en python sea la que corresponde, hay algunos parametros que se pueden
        utilizar para no usar la se~nal completa, como por ejemplo, el promedio, la norma infitito"""
